...
export const ShopCard = ({shop, setCurrentOrders, toggleShop})=>{
    ...
    return(
        <Card chart className={classes.addCursor} onClick={()=> {toggleShop(val => !val); setCurrentOrders(shop)}}>
            ...
            <CardBody>
                ...
                <div className={classes.cardCategory}>
                    ...
                    product in shop
                    <p style={{marginTop: '0.3em', fontSize: '1.1em'}}>Best selling product: <br/> <span style={{ fontWeight: 600}}>{shop.products[0].name}</span></p>
