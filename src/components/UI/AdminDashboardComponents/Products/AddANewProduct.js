...
const AddANewProduct = (props) => {
    ...
    const [description, setDescription] = useState(["11 Programmable Buttons", "Ergonomic Design"]); //csv
    const [dimension, setDimension] = useState("");
    const [weight, setWeight] = useState("");
    const [specs, setSpecs] = useState(["Connection Type: Wired", "Max Speed: 450IPS"]); //csv
    const [branch, setBranch] = useState("");
    const [origin, setOrigin] = useState("");   // get country list
    const [discount, setDiscount] = useState();
    const [colors, setColors] = useState(["Black&Red", "Black&Green", "Black&Blue"]);
                ...
                <Grid item xs={12} sm={12} md={8}>
                    <Card style={{marginLeft: '13vw'}}>
                        <CardHeader color="tiki">
                            ...
                            <p className={classes.cardCategoryWhite}>Create a new product</p>
                        </CardHeader>
                        <CardBody>
                            <ValidatorForm onSubmit={handleSubmit}>
                                <FormGroup>
                                    ...
                                    <FormControl>
                                        <p style={{color: "rgba(0, 0, 0, 0.54)", fontSize:"0.9rem", fontWeight: 400, marginLeft: '0.6em', marginBottom: '0.5em', marginTop: "1em"}}>Product Image</p>
                                        <Upload
                                            files={[photo]}
                                            // onAdd={(e)=>onAdd(e)}
                                            restrictions={{
                                            ...
                                            onRemove={() => {setPhoto(null); setPhotoFile(null)}}
                                            batch={false}
                                            multiple={false}
                                            defaultFiles={[]}
