...
const ProductStats = (props) => {
    ...
    const convertDateToDay = () => {
        ...
        allProducts !== null && allProducts.forEach((review, index) => {
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} className={classes.card}>
                    ...
                    <Card chart onClick={convertDateToDay}>
                        ...
                        <CardBody>
                            <h4 className={classes.cardTitle}>Amount of Products created in the last 7 days </h4>
                            <p className={classes.cardCategory}>
                <span className={classes.successText}>
                  <ArrowUpward className={classes.upArrowCardCategory}/> {productChart.data.series[0].slice(-1)[0]}
                </span>{" "}
                        ...
                        <CardFooter chart>
                            <div className={classes.stats}>
                                <AccessTime/>
                                <Moment fromNow style={{textTransform: "capitalize"}}>{productLastUpdated}</Moment>
