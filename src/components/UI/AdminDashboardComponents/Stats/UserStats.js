...
const UserStats = (props) => {
    ...
    const convertDateToDay = () => {
        ...
        allUsers !== null && allUsers.forEach((review, index) => {
            ...
            <Grid container spacing={3} justify={'space-around'}>
                {
                    ...
                    <ReactLoading type={"balls"} color={"#189EFF"} width={'5%'} height={'5%'} className={classes.loading4}/>
                }
                <Grid item xs={props.fullwidth !== undefined? 12: 10} className={classes.card}>
                    {userChart !== null &&
                    <Card chart onClick={convertDateToDay}>
                        ...
                        <CardBody>
                            <h4 className={classes.cardTitle}>Amount of new users in the last 7 days </h4>
                            <p className={classes.cardCategory}>
                <span className={classes.successText}>
                  <ArrowUpward className={classes.upArrowCardCategory}/> {userChart.data.series[0].slice(-1)[0]}
                </span>{" "}
                        ...
                        <CardFooter chart>
                            <div className={classes.stats}>
                                <AccessTime/>
                                <Moment fromNow style={{textTransform: "capitalize"}}>{userLastUpdated}</Moment>
